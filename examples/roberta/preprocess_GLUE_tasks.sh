...
wget -N 'https://dl.fbaipublicfiles.com/fairseq/gpt2_bpe/encoder.json' -O ./examples/roberta/encoder.json
wget -N 'https://dl.fbaipublicfiles.com/fairseq/gpt2_bpe/vocab.bpe' -O ./examples/roberta/vocab.bpe
wget -N 'https://dl.fbaipublicfiles.com/fairseq/gpt2_bpe/dict.txt' -O ./examples/roberta/dict.txt
...
do
  ...
  do
    ...
    do
      ...
      --encoder-json ./examples/roberta/encoder.json \
      --vocab-bpe ./examples/roberta/vocab.bpe \
  ...
  do
    ...
    fairseq-preprocess \
      ...
      --destdir "./examples/roberta/$TASK-bin/$LANG" \
      --workers 60 \
      --srcdict ./examples/roberta/dict.txt;
  done
  if [[ "$TASK" !=  "STS-B" ]]
  then
    fairseq-preprocess \
      ...
      --destdir "./examples/roberta/$TASK-bin/label" \
      --workers 60;
  else
